...
{
    [TestFixture]
    internal sealed class FOpacityTests
    {
        // -----------------------------------------------------------------------
        // Constructor
        // -----------------------------------------------------------------------
        ...
        {
            var element = new FOpacity(value: 0.5f, child: new FText("x"));
        ...
        {
            var element = new FOpacity(value: 1.5f, child: new FText("x"));
        ...
        public void Constructor_SetsChild()
        {
            ...
            var element = new FOpacity(value: 1f, child: child);
        ...
        public void Constructor_NullChild_Throws()
        {
            Assert.Throws<ArgumentNullException>(() =>
                _ = new FOpacity(value: 1f, child: null!));
        }

        [Test]
        public void Constructor_SetsKey()
        {
            var key = new FValueKey<string>("op");
            var element = new FOpacity(value: 0.8f, child: new FText("x"), key: key);
        ...
        public void GetChildren_ReturnsSingleChild()
        {
            ...
            var element = new FOpacity(value: 0.5f, child: child);
        ...
        {
            var element = new FOpacity(value: 0.7f, child: new FText("x"));
        ...
        {
            var original = new FOpacity(value: 0.5f, child: new FText("x"));
            var native = FElementPainter.CreateNative(original);

            var updated = new FOpacity(value: 0.9f, child: new FText("x"));
        ...
        {
            var element = new FOpacity(value: 0.4f, child: new FText("x"));
        ...
        {
            var original = new FOpacity(value: 0.2f, child: new FText("x"));
            var native = FElementPainter.CreateNative(original);

            var updated = new FOpacity(value: 0.8f, child: new FText("x"));
