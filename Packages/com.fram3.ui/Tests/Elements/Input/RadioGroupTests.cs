...
namespace Fram3.UI.Tests.Elements.Input
{
    ...
    internal sealed class RadioGroupTests
    {
        ...
        public void Constructor_SetsOptions()
        {
            ...
            var element = new RadioGroup(options);
        ...
        {
            var element = new RadioGroup(new List<string> { "A" });
        ...
        {
            var element = new RadioGroup(new List<string> { "A", "B" }, selectedValue: "B");
        ...
        public void Constructor_SetsOnChanged()
        {
            ...
            var element = new RadioGroup(new List<string> { "A" }, onChanged: callback);
        ...
        {
            var key = new ValueKey<string>("rg");
            var element = new RadioGroup(new List<string> { "A" }, key: key);
