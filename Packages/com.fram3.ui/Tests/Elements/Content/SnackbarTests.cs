...
{
    [TestFixture]
    internal sealed class SnackbarTests
    {
        [Test]
        public void Constructor_SetsMessage()
        {
            var element = new Snackbar("Saved successfully");
        ...
        {
            var element = new Snackbar("msg", actionLabel: "Undo");
        ...
        public void Constructor_SetsOnAction()
        {
            ...
            var element = new Snackbar("msg", onAction: callback);
        ...
        {
            var element = new Snackbar("msg", duration: 8f);
        ...
        {
            var key = new ValueKey<string>("sb");
            var element = new Snackbar("msg", key: key);
