...
namespace Fram3.UI.Tests.Elements.Content
{
    ...
    internal sealed class ProgressBarTests
    {
        ...
        {
            var element = new ProgressBar(value: 0f);
        ...
        {
            var element = new ProgressBar(value: 0.5f, min: 0f, max: 1f);
        ...
        {
            var key = new ValueKey<string>("pb");
            var element = new ProgressBar(value: 0f, key: key);
