...
{
    [TestFixture]
    internal sealed class FCubitBuilderTests
    {
        ...
        public void Constructor_NullBuilder_ThrowsArgumentNullException()
        {
            Assert.Throws<ArgumentNullException>(() =>
                new FCubitBuilder<CounterCubit, int>(null!));
        }
        ...
        public void Mount_BuildsSubtreeWithInitialState()
        {
            ...
            var tree = new FProvider<CounterCubit>(
                cubit,
                new FCubitBuilder<CounterCubit, int>((_, state) =>
                {
                    captured = state;
        ...
        public void StateChange_SchedulesRebuild()
        {
            ...
            var tree = new FProvider<CounterCubit>(
                cubit,
                new FCubitBuilder<CounterCubit, int>((_, _) => new TestLeafElement("leaf")));
