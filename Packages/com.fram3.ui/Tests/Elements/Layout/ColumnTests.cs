...
namespace Fram3.UI.Tests.Elements.Layout
{
    ...
    internal sealed class ColumnTests
    {
        ...
        public void Constructor_StoresAlignments()
        {
            ...
            Assert.That(element.MainAxisAlignment, Is.EqualTo(MainAxisAlignment.Center));
            Assert.That(element.CrossAxisAlignment, Is.EqualTo(CrossAxisAlignment.Stretch));
        }

        [Test]
        public void Constructor_StoresKey()
        {
            var key = new ValueKey<string>("col");
            var element = new Column(key: key);
