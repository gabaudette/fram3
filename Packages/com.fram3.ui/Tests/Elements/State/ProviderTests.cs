...
{
    [TestFixture]
    internal sealed class ProviderTests
    {
        ...
        {
            var old = new Provider<int>(1, new TestLeafElement("a"));
            var current = new Provider<int>(2, new TestLeafElement("b"));
        ...
        {
            var old = new Provider<int>(5, new TestLeafElement("a"));
            var current = new Provider<int>(5, new TestLeafElement("b"));
        ...
        {
            var old = new Provider<string>("hello", new TestLeafElement("a"));
            var current = new Provider<int>(5, new TestLeafElement("b"));
        ...
        {
            Provider<int>? found = null;
            var element = new TestStatelessElement(ctx =>
            {
                found = ctx.FindInherited<Provider<int>>();
                return new TestLeafElement("leaf");
            });
