...
{
    [TestFixture]
    public class FEdgeInsetsTests
    {
        [Test]
        public void Constructor_SetsAllEdges()
        {
            var insets = new FEdgeInsets(1f, 2f, 3f, 4f);
        ...
        {
            var insets = FEdgeInsets.Symmetric(vertical: 4f, horizontal: 8f);
        ...
        {
            var insets = FEdgeInsets.OnlyTop(5f);
        ...
        {
            var insets = FEdgeInsets.OnlyRight(5f);
        ...
        {
            var insets = FEdgeInsets.OnlyBottom(5f);
        ...
        {
            var insets = FEdgeInsets.OnlyLeft(5f);
        ...
        {
            Assert.That(FEdgeInsets.Zero, Is.EqualTo(new FEdgeInsets(0f, 0f, 0f, 0f)));
        }

        [Test]
        public void Horizontal_ReturnsSumOfLeftAndRight()
        {
            var insets = new FEdgeInsets(0f, 3f, 0f, 5f);
        ...
        {
            var insets = new FEdgeInsets(3f, 0f, 5f, 0f);
        ...
        {
            var a = FEdgeInsets.All(4f);
            var b = FEdgeInsets.All(4f);
        ...
        {
            Assert.That(FEdgeInsets.All(4f), Is.Not.EqualTo(FEdgeInsets.All(8f)));
        }
    }
}
