...
{
    [TestFixture]
    public class ChildElementTests
    {
        [Test]
        ...
        public void MultiChildElement_GetChildren_ReturnsAllChildren()
        {
            ...
            var parent = new TestMultiChildElement { Children = new Element[] { a, b } };
        ...
        {
            var parent = new TestMultiChildElement { Children = Array.Empty<Element>() };
