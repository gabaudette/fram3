...
namespace Fram3.UI.Core
{
    ...
    /// </remarks>
    public abstract class InheritedElement : SingleChildElement
    {
        /// <summary>
        /// Creates a new inherited element with an optional key.
        /// </summary>
        /// <param name="key">An optional key for reconciliation identity.</param>
        protected InheritedElement(Key? key = null) : base(key)
        {
        }
        ...
        /// </returns>
        public abstract bool UpdateShouldNotify(InheritedElement oldElement);
    }
}