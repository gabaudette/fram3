...
namespace Fram3.UI.Core
{
    ...
    public abstract class State
    {
        ...
        /// </summary>
        protected StatefulElement? Element => _node?.Element as StatefulElement;
        ...
        /// </summary>
        public BuildContext? Context => _node?.Context;
        ...
        public virtual void DidUpdateElement(StatefulElement oldElement)
        {
        }
    ...
    /// Inherit from this class to create state for a specific StatefulElement subclass,
    /// giving convenient access to the element's properties without casting.
    /// </summary>
    /// <typeparam name="T">The type of StatefulElement this state is associated with.</typeparam>
    public abstract class State<T> : State where T : StatefulElement
    {
        /// <summary>
