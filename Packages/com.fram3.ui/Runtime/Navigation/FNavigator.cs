...
namespace Fram3.UI.Navigation
{
    ...
    public sealed class FNavigator : FStatefulElement
    {
        ...
        /// <summary>
        /// Creates an <see cref="FNavigator"/> with the given routes and initial route.
        /// </summary>
        /// <param name="routes">
