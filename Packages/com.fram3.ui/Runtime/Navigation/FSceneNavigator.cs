...
namespace Fram3.UI.Navigation
{
    ...
    public static class FSceneNavigator
    {
        ...
        /// <see cref="FSceneOperation"/> that tracks progress and fires a
        /// <see cref="FSceneOperation.Completed"/> event when the scene is active.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// An <see cref="FSceneOperation"/> whose <see cref="FSceneOperation.Progress"/>
