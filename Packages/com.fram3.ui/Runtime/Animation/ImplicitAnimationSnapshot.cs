...
namespace Fram3.UI.Animation
{
    ...
    public sealed class ImplicitAnimationSnapshot
    {
        ...
        internal ImplicitAnimationSnapshot(IReadOnlyDictionary<string, object> values)
        {
            _values = values;
        }
        ...
        /// <param name="key">The key provided when the <see cref="AnimatedValue{T}"/> was created.</param>
