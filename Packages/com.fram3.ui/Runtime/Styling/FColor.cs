...
{
    /// <summary>
    /// An immutable RGBA color value with each channel in the range [0, 1].
    /// </summary>
    public readonly struct FColor : IEquatable<FColor>
    {
        ...
        /// <summary>The alpha channel in the range [0, 1]. 0 is fully transparent, 1 is fully opaque.</summary>
        public float A { get; }

        /// <summary>
        /// Creates a new color from normalized RGBA channel values.
        /// </summary>
        ...
        /// <summary>Returns a copy of this color with the alpha channel set to <paramref name="a"/>.</summary>
