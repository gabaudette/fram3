...
namespace Fram3.UI.Styling
{
    ...
    public readonly struct EdgeInsets : IEquatable<EdgeInsets>
    {
        ...
        /// <returns>An <see cref="EdgeInsets"/> with equal values on all edges.</returns>
        public static EdgeInsets All(float all) => new(all, all, all, all);
