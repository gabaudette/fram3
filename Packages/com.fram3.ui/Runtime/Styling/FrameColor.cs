...
namespace Fram3.UI.Styling
{
    ...
    public readonly struct FrameColor : IEquatable<FrameColor>
    {
        ...
        /// <returns>A new <see cref="FrameColor"/> with normalized channel values.</returns>
        public static FrameColor FromRgba255(byte r, byte g, byte b, byte a = 255)
        {
            return new FrameColor(r / 255f, g / 255f, b / 255f, a / 255f);
        }
        ...
        /// <returns>A new <see cref="FrameColor"/> parsed from the hex string.</returns>
        ...
        /// </exception>
        public static FrameColor FromHex(string hex)
        {
            if (hex == null)
            {
        ...
        /// <returns>A new <see cref="FrameColor"/> with the updated alpha channel.</returns>
        public FrameColor WithAlpha(float a) => new(R, G, B, a);

        /// <summary>Fully transparent black.</summary>
        public static FrameColor Transparent => new(0f, 0f, 0f, 0f);

        /// <summary>Opaque white.</summary>
        public static FrameColor White => new(1f, 1f, 1f);

        /// <summary>Opaque black.</summary>
        public static FrameColor Black => new(0f, 0f, 0f);

        /// <summary>Opaque red.</summary>
        public static FrameColor Red => new(1f, 0f, 0f);

        /// <summary>Opaque green.</summary>
        public static FrameColor Green => new(0f, 1f, 0f);
        ...
        public static bool operator ==(FrameColor left, FrameColor right) => left.Equals(right);

        public static bool operator !=(FrameColor left, FrameColor right) => !left.Equals(right);

        /// <inheritdoc />
        public override string ToString() => $"FrameColor(r:{R:F3}, g:{G:F3}, b:{B:F3}, a:{A:F3})";
    }
}