...
namespace Fram3.UI.Elements.Content
{
    ...
    public sealed class FTabView : FStatefulElement
    {
        ...
        public IReadOnlyList<FTab> Tabs { get; }
        ...
        /// <summary>
        /// Creates an <see cref="FTabView"/> element.
        /// </summary>
        ...
        /// <inheritdoc/>
        public override FState CreateState() => new FTabViewState();

        private sealed class FTabViewState : FState<FTabView>
        {
            ...
            public override FElement Build(FBuildContext context)
            {
                ...
                var tabBarButtons = new FElement[tabs.Count];

                for (var i = 0; i < tabs.Count; i++)
                {
                    var capturedIndex = i;
                    tabBarButtons[i] = new FButton(
                        label: tabs[i].Label,
                ...
                return new FColumn
                {
                    ...
                    {
                        new FRow { Children = tabBarButtons },
