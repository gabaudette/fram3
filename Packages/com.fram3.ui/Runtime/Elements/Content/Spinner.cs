...
namespace Fram3.UI.Elements.Content
{
    ...
    /// The animation is driven by an internal <c>AnimationController</c> and
    /// requires <c>Renderer.Tick</c> to be called each frame.
    ...
    public sealed class Spinner : LeafElement
    {
        ...
        /// <summary>
        /// Creates an <see cref="Spinner"/> element.
        /// </summary>
