...
namespace Fram3.UI.Elements
{
    ...
    /// <para>
    /// The <see cref="Source"/> property accepts a <c>UnityEngine.UIElements.VectorImage</c>.
    /// It is typed as <c>object?</c> so the element can be declared in files that are
    /// compiled without Unity.
    /// </para>
    /// </summary>
    public sealed class FIcon : FLeafElement
    {
        ...
        /// </summary>
        /// <param name="source">A <c>UnityEngine.UIElements.VectorImage</c> to display.</param>
